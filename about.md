...
<div class="container" style="padding-top: 56px; padding-bottom: 80px;">
  <div class="eyebrow" style="margin-bottom: 14px;">section · 006</div>
  <h1 class="h-display" style="font-size: 56px; margin: 0 0 36px;">About</h1>
...
**[Essays](/essays)** are the longer pieces: technical write-ups, GDC recaps, the occasional philosophy tangent. Edited when they feel done enough.
...
Built with [Jekyll](https://jekyllrb.com/) and hosted on GitHub Pages. Typeset in Newsreader, Inter Tight, and JetBrains Mono. Written in plaintext Markdown.
