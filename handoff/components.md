...
```html
<a href="/tag/ml" class="tag">#ml</a> <a class="tag is-active">#ml</a>
```
...
<aside class="now">
  ...
  <ul>
    <li>
      <span class="now-key">writing</span
      ><span class="now-val"
        >An essay on what interpretability papers are actually claiming.</span
      >
    </li>
    <li>
      <span class="now-key">building</span
      ><span class="now-val"
        ><code>tinyrouter</code> — a 24M-param classifier…</span
      >
    </li>
    <li>
      <span class="now-key">reading</span
      ><span class="now-val">Stiegler, <em>Technics and Time, 1</em>.</span>
    </li>
  </ul>
...
<aside class="toc">
  ...
  <div class="toc-progress">
    <div class="toc-progress-bar" style="width: 32%"></div>
  </div>
...
<aside class="sidenote">
  ...
  See Anthropic's <em>monosemanticity</em> work for a related anxiety, framed
  differently.
</aside>
```
...
<a href="/note/slug" class="note-card">
  ...
  <footer><span>↳ 4 links</span><span>read →</span></footer>
</a>
```
...
.book-cover {
  ...
  background: linear-gradient(
    160deg,
    var(--cover),
    color-mix(in oklab, var(--cover) 60%, black)
  );
  position: relative;
  overflow: hidden;
  box-shadow:
